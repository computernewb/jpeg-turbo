...
#if 0 	// CT: This bounds check is partially flawed in nature, and rejects seemingly valid data.
		// The best solution is to figure out why this is broken and replace it with a good fix,
		// but disabling it has seemed to work. (And isn't as much of a security issue because
		// we use this in a context where user-controlled input isn't a problem)
